...
import { Smartphone, Zap, Users, Shield, Code2, Sparkles, ArrowRight, ArrowLeft, Play } from 'lucide-react';
...
const MobileAppDevelopment = () => {
      ...
      particles.forEach((particle, i) => {
        ...
        particles.forEach((particle2, j) => {
          if (i !== j) {
            ...
            if (distance < 120) {
              ctx.beginPath();
              ctx.strokeStyle = `rgba(100, 116, 139, ${0.1 * (1 - distance / 120)})`;
              ctx.lineWidth = 0.5;
  ...
  const services = [
    {
      ...
      description: "Platform-specific performance and features",
  ...
  const process = [
    {
      phase: "01",
      title: "Strategy",
      description: "Define your app's purpose, target audience, and core features through market research.",
    ...
    },
    {
      phase: "02",
      title: "Design",
      description: "Create intuitive user experiences with pixel-perfect interface design.",
    ...
    },
    {
      phase: "03",
      title: "Develop",
      description: "Build robust, scalable mobile applications with cutting-edge technology.",
    ...
    },
    {
      phase: "04",
      title: "Launch",
      description: "Deploy to app stores with ongoing support and performance monitoring.",
  ...
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hi! I'm interested in your Mobile App Development services. Can we discuss my app project?");
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden">
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-white/70 max-w-3xl mb-12 leading-relaxed">
            ...
            and drive business growth across iOS, Android, and cross-platform environments.
          </p>
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/60">From idea to app store success</p>
          </div>
              ...
              <div className="flex items-start gap-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-lg leading-relaxed">
                    We begin by understanding your app idea, target users, and business goals. Through an in-depth discovery session, we define the app's purpose, core features, and platform requirements (Android, iOS, or cross-platform). From there, we prepare a detailed project roadmap and prototype to visualize the user experience before development begins.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 md:p-12 hover:border-white/40 transition-all duration-500">
              <div className="flex items-start gap-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-lg leading-relaxed">
                    Our team of designers and developers collaborate to create an intuitive, high-performance mobile app. We focus on seamless functionality, engaging design, and scalability. Throughout the process, we conduct multiple rounds of testing to ensure smooth performance, security, and user satisfaction. Once ready, we handle deployment and provide ongoing support to keep your app running at its best.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 md:p-12 hover:border-white/40 transition-all duration-500">
              <div className="flex items-start gap-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-lg leading-relaxed">
                    A custom mobile app strengthens your brand presence, enhances customer engagement, and streamlines business operations. With most users relying on mobile devices daily, having a well-built app helps you stay connected to your audience, increase visibility, and create lasting value for your business.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="relative bg-gradient-to-br from-slate-700 via-slate-800 to-slate-700 rounded-[3rem] p-12 md:p-20 overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-10 max-w-3xl mx-auto leading-relaxed">
                Let's bring your mobile app vision to life with cutting-edge technology 
                and user-centered design. Create an app that users love.
              </p>
              ...
              >
                <span className="flex items-center gap-2">
                  Start Your App Project on WhatsApp
                  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </span>
              </button>
            </div>
      ...
      <footer className="relative z-10 px-6 py-12 border-t border-white/10">
        <div className="max-w-7xl mx-auto text-center text-white/40">
          <p>© 2025 Admark Tech. Building mobile excellence.</p>
        </div>
      </footer>
    </div>
  );
