...
import { Palette, Target, Layers, Pen, Brush, Eye, Sparkles, ArrowRight, ArrowLeft, Star } from 'lucide-react';
...
const BrandingDesign = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < particleCount; i++) {
      particles.push({
        ...
        color: Math.random() > 0.5 ? '100, 116, 139' : '148, 163, 184' // slate colors
      });
    }
  ...
  const services = [
    {
      ...
      description: "Logos, colors, and visual systems",
    ...
    },
    {
      ...
      description: "Consistent application standards",
      color: "from-slate-600 to-slate-700"
    }
  ];
  ...
  const process = [
    {
      phase: "01",
      title: "Discover",
      description: "Explore your brand's story, values, and audience to understand what makes you unique.",
    ...
    },
    {
      phase: "02",
      title: "Create",
      description: "Develop logos, color palettes, and comprehensive brand guidelines.",
    ...
    },
    {
      phase: "03",
      title: "Execute",
      description: "Apply your brand across all touchpoints with consistency and impact.",
    ...
    },
    {
      phase: "04",
      title: "Evolve",
      description: "Refine and adapt your brand as your business grows and markets change.",
  ...
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hi! I'm interested in your Branding & Design services. Can we discuss my brand project?");
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden">
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-6xl md:text-8xl font-black mb-6 leading-none">
            ...
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-slate-400 via-pink-400 to-slate-400">
              Lasting Impact
            </span>
          </h1>

          <p className="text-xl md:text-2xl text-white/70 max-w-3xl mb-12 leading-relaxed">
            Transform your business vision into a compelling brand identity that resonates 
            with your audience and drives meaningful connections.
          </p>
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/60">From concept to completion</p>
          </div>
              ...
              <div className="flex items-start gap-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-lg leading-relaxed">
                    We begin by exploring your brand's story, values, and audience to understand what makes your business unique. Through research and strategy sessions, we define your brand identity, tone, and visual direction. This foundation helps us create a clear and consistent design approach that reflects your vision and connects with your audience.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 md:p-12 hover:border-white/40 transition-all duration-500">
              <div className="flex items-start gap-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-lg leading-relaxed">
                    Our creative team develops everything from logos and color palettes to full brand guidelines and marketing materials. We focus on creating cohesive visuals that align with your message and make your brand instantly recognizable. Every design is tested for versatility across digital and print platforms to ensure consistency everywhere your brand appears.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 md:p-12 hover:border-white/40 transition-all duration-500">
              <div className="flex items-start gap-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-lg leading-relaxed">
                    Strong branding is more than just a logo—it's the emotional connection people have with your business. Effective design builds trust, recognition, and loyalty, helping your brand stand out in a crowded market. A well-crafted brand identity ensures you leave a lasting impression and communicate your value with clarity and confidence.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="relative bg-gradient-to-br from-slate-700 via-slate-800 to-slate-700 rounded-[3rem] p-12 md:p-20 overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full mb-8">
                ...
                <span className="font-semibold">Brand Excellence Awaits</span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-10 max-w-3xl mx-auto leading-relaxed">
                ...
                Every great business deserves a brand that reflects its true potential.
              </p>
              ...
              >
                <span className="flex items-center gap-2">
                  Start Your Brand Journey on WhatsApp
                  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </span>
              </button>
            </div>
      ...
      <footer className="relative z-10 px-6 py-12 border-t border-white/10">
        <div className="max-w-7xl mx-auto text-center text-white/40">
          <p>© 2025 Admark Tech. Crafting creative excellence.</p>
        </div>
      </footer>
    </div>
  );
